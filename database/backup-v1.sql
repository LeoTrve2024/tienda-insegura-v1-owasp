-- ============================================================
-- BACKUP LÓGICO REPRODUCIBLE - TIENDA INSEGURA v1
-- Fecha de preparación: 2026-08-01
--
-- Uso:
--   psql -U tienda_user -d tienda_insegura -f database/backup-v1.sql
--
-- ADVERTENCIA: elimina y recrea las tablas del laboratorio.
-- ============================================================
